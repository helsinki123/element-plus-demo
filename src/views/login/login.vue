<template>
    <div class="login-vue" :style="bg">
        <div class="container">
            ...
            <div class="input-c">
                <el-input prefix="ios-contact" v-model="account" placeholder="用户名" clearable @on-blur="verifyAccount" />
                <p class="error">{{accountError}}</p>
            </div>
            <div class="input-c">
                <el-input type="password" v-model="pwd" prefix="md-lock" placeholder="密码" clearable @on-blur="verifyPwd"
...
.login-vue {
    ...
    align-items: center;
    color: #fff;
    background: url("@static/imgs/ocean.jpg") no-repeat;
